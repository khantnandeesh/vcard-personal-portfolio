...
// testimonials variables (guarded in case section is removed)
...
// add click event to all modal items if present
...
// add event in all select items if present
...
// add event in all filter button items for large screen if present
